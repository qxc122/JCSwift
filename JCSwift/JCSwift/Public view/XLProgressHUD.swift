...
extension UIView{
    ...
    // 只含有提示信息的提示
    public func showMessage(message:String?,interval:CGFloat?=0.8,position:AnyObject?="center" as AnyObject){
    ...
    // 含有提示信息和图片的提示
    public func showMessageAndImage(message:String?,image:UIImage?,interval:CGFloat?=0.8,position:AnyObject?="center" as AnyObject){
    ...
    // 含有标题、信息和图片的提示
    public func showTitleMessageAndImage(title:String?,message:String?,image:UIImage?,interval:CGFloat?=0.8,position:AnyObject?="center" as AnyObject){
    ...
    // 含有提示信息的加载提示
    public func showLoadingTilteActivity(message:String,position:AnyObject?="center" as AnyObject){
    ...
    // 控件显示（控件显示停留时间与动画）
    private func showView(_ view:UIView,interval:CGFloat,point:AnyObject){
...
//                        self.isUserInteractionEnabled = true
    ...
    // 设置控件位置
    private func centerPointForPositon(_ view:UIView,point:AnyObject?) -> CGPoint{
    ...
    // 创建有时间间隔显示的控件
    private func viewForMessage(_ title:String?,message:String?,image:UIImage?) ->UIView?{
        ...
        if title != nil {
            ...
            let expextesTitleSize = titleStr.boundingRect(with: maxTitleSize, options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: [kCTFontAttributeName as NSAttributedStringKey: (titleLabel?.font)!], context: nil)
            ...
            titleHeight = (imageView?.bounds.height)!
        ...
        if message != nil {
            ...
            let expextesMessageSize = messageStr.boundingRect(with: maxMessageSize, options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: [kCTFontAttributeName as NSAttributedStringKey: (messageLabel?.font)!], context: nil)
    ...
    // 创建一直显示的View
    private func activityView(_ text:String?,position:AnyObject?){
    ...
    private func hideActivityView(){
        ...
        if existingActivityView != nil {
            ...
            UIView.animate(withDuration: fadeDuration,
                    ...
                    let tmp:UIView = existingActivityView as! UIView
